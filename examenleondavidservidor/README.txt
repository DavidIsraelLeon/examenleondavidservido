...
a persistence unit "examenleondavidservidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenleondavidservidor\pom.xml":
...
artifact ("examenleondavidservidor.war") is already built. You can build
